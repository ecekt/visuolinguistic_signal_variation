...
if not os.path.isdir('data/didec/bertdutch_sentencereps_pooler'):
    os.mkdir('data/didec/bertdutch_sentencereps_pooler')
...
for pair in prompts:
    ...
    sentence_rep = output.pooler_output.squeeze()

    torch.save(sentence_rep, 'data/didec/bertdutch_sentencereps_pooler/bertrep_pooler_' + p + '_' + i + '.pt')
