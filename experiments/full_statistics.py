...
print(len(means), len(stds), len(specs))
print('Means')
print(round(np.mean(means), 2), round(max(means), 2), round(min(means), 2))
print()
print('SD')
print(round(np.mean(stds), 2), round(max(stds), 2), round(min(stds), 2))
print()
print('Img Spec BLEU-2')
print(round(np.mean(specs), 2), round(max(specs), 2), round(min(specs), 2))
