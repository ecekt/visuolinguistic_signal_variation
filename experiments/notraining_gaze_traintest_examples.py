...
for c in range(trial_count):
    ...
    for split in datapaths:
        ...
        for im in datasplit:
            ...
            dataset_param[im] = {'gazessd': gazeSSD[im]}
    ...
    for spl in splits:
        ...
        for img in original_data[spl]:
            ...
            target_ons = torch.tensor(original_data[spl][img]['gazessd'])
            ...
            for sc in samples_closest:
                ...
                mean_ons = original_data['train'][sc_img]['gazessd']
        ...
        print(spl, 'k', k, 'gaze SSD interpretable loss avg sqrt', round(total_loss / len(original_data[spl]), 4))
        ...
        print(spl, 'correlation avg target spec vs. predicted gaze SSD')
...
print('corr between target gazeSSD and predicted gazeSSD')
