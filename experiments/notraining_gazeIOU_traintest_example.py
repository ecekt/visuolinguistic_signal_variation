...
for c in range(trial_count):
    ...
    for split in datapaths:
        ...
        for im in datasplit:
            ...
            dataset_param[im] = {'gazeIOU': gazeIOU[im]}
    ...
    for spl in splits:
        ...
        for img in original_data[spl]:
            ...
            target_ons = torch.tensor(original_data[spl][img]['gazeIOU'])
            ...
            for sc in samples_closest:
                ...
                mean_ons = original_data['train'][sc_img]['gazeIOU']
        ...
        print(spl, 'k', k, 'gaze IOU interpretable loss avg sqrt', round(total_loss / len(original_data[spl]), 4))
        ...
        print(spl, 'correlation avg target spec vs. predicted gaze IOU')
...
print('corr between target gazeIOU and predicted gazeIOU')
...
print('min pred gaze var:', min_pred_im, str(round(min_pred_val, 3)))
print('max pred gaze var:', max_pred_im, str(round(max_pred_val, 3)))